...
-- REMOVE 'USE movie_share_db;'

-- Connect to 'movie_share_db' database in pgAdmin or your client before running the below:
...
CREATE TABLE movie_details (
    ...
    rental_cost NUMERIC(8,2) CHECK (rental_cost >= 0.00 AND rental_cost <= 100.00),
    awards VARCHAR(255),
